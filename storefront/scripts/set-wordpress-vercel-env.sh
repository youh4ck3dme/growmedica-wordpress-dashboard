...
NEXT_PUBLIC_DASHBOARD_MODE="${NEXT_PUBLIC_DASHBOARD_MODE:-hybrid}"
# Soft-launch: keep noindex until SITE_NOINDEX=0
SITE_NOINDEX="${SITE_NOINDEX:-1}"
NEXT_PUBLIC_SITE_NOINDEX="${NEXT_PUBLIC_SITE_NOINDEX:-$SITE_NOINDEX}"
...
PUBLIC_VARS=(
  ...
  "NEXT_PUBLIC_SITE_NOINDEX|$NEXT_PUBLIC_SITE_NOINDEX"
