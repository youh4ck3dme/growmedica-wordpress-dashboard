...
export function getBundleImageSrc(slug: string): string | null {
  if (!BUNDLE_IMAGE_SLUGS.has(slug)) return null
  return `/images/balicky/${slug}.webp`
}
